        ...
        <c:forEach var="exhibitionEvent" items="${requestScope.exhibitionEventPageable.items}">
            <tr>
                ...
                <td>
                    ...
                    <form class="p-2"
                          action="${pageContext.request.contextPath}/app/admin/update-exhibition-event-status"
                          method="get">
                        ...
                        <input name="exhibitionEventId" type="number" value="${exhibitionEvent.id}"
                               style="display: none">

                        <button type="submit" class="btn btn-primary" style="font-size: 12px">
                            <fmt:message key="admin_panel.exhibition_event.button.save"/>
                        </button>
                    </form>
                </td>
                <td>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            <c:forEach var="pageNumber" begin="1" end="${requestScope.pageAmount}">
                <li class="page-item">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/app/admin/exhibition-event-list?pageId=${pageNumber}">
                            ${pageNumber}
                    </a>
                </li>
            </c:forEach>
